...
export const createSale = async (sale) => {
    ...
    try {
        ...
        const saleInsert = await client.query('INSERT INTO sales (total_amount, tax_tps, tax_tvq, final_total, payment_method, status) VALUES ($1, $2, $3, $4, $5, $6)', [total_amount, tax_tps, tax_tvq, final_total, payment_method, 'Completed']);
        ...
        for (const item of items) {
            await client.query('INSERT INTO sale_items (sale_id, product_id, quantity, unit_price, is_manual, manual_name) VALUES ($1, $2, $3, $4, $5, $6)', [saleId, item.product_id, item.quantity, item.unit_price, item.is_manual ? 1 : 0, item.manual_name]
        ...
        // 3. Record Payment
        await client.query('INSERT INTO payments (sale_id, amount, method) VALUES ($1, $2, $3)', [saleId, final_total, payment_method]);
